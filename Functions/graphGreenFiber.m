...
if data.session_id == "Cond"
    legend({'490 nm', 'tone', 'freeze', 'shock'},'Fontsize',16, 'Location', 'northeast');
else
    legend({'490 nm', 'tone', 'freeze'},'Fontsize',16, 'Location', 'northeast');
end
...
if data.session_id == "Cond"
    legend({'465 nm', 'tone', 'freeze', 'shock'},'Fontsize',16, 'Location', 'northeast');
else
    legend({'465 nm', 'tone', 'freeze'},'Fontsize',16, 'Location', 'northeast');
end
